    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_time', models.DateField(default=datetime.datetime(2021, 1, 9, 12, 29, 30, 375151, tzinfo=utc), verbose_name='组创建日期')),
            ],
            options={
                'verbose_name': '工作组',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('workgroups', models.ManyToManyField(blank=True, to='account.WorkGroup', verbose_name='所在工作组')),
            ],
            options={
                'verbose_name': '用户',
